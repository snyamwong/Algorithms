...
*/
public class ChartMaker_sorted extends ApplicationFrame {
     ...
     */
    public ChartMaker_sorted(String title) {
        super(title);
    ...
    private static JFreeChart createChart() {
    	...
    	data[0] = createDataset('b', "binary tree");
    	data[1] = createDataset('r', "red-black tree");
    	
    	
        JFreeChart chart = ChartFactory.createXYLineChart(
            "Sorted tree insertion runtimes ",// chart title
    ...
    public static void main(String[] args) {
        ChartMaker_sorted cm = new ChartMaker_sorted(
                "Chart Window");
        cm.pack();
